                ...
                <div className="bg-[#605EEF] px-6 pt-10 sm:pb-32 lg:col-span-7 lg:px-0 lg:pt-48 xl:col-span-6">
                    <div className="mx-auto max-w-2xl lg:mx-0">
                        ...
                        <div className="mt-10 flex items-center gap-x-6">
                            ...
                            <a href="#" className="bg-white hover:bg-transparent hover:outline hover:outline-1 hover:outline-black transition-transform ease-out duration-100 rounded-full px-4 py-1 text-[16px] leading-6 text-black">
